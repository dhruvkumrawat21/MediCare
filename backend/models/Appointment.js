...
const appointementSchema = new mongoose.Schema({
    ...
    sessionId: { type: String, default: null, index: true }, paidAt: { type: Date, default: null },
}, {
    timeStamps: true
});

const Appointment = mongoose.models.Appointment || mongoose.model("Appointment", appointementSchema);
