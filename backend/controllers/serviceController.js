...
//this below function will convert array like input into the clean array
//and if the input arra y is empty or invalid it will return the empty array   
...
//this function takes the date time slot string and group them into a (YYYY-MM-DD) with the time 
...
//saftley coverts the string to the number 
...
//this service will created by the admin panel
...
export async function createService(req, res) {
    try {
        ...
        }//if the file is present it will be uploades to service folder in the cloudinary
...
//to get a particular service by id 
            ...
            try {
                ...
                if (up?.secure_url) {
                    ...
                    if (existing.imagePublicId) {
                        //it will remove the old image and replace it will the new one 
                        try {
