...
import {ArrowRight, FolderTree, Mail, MapPin, Phone, Send, Stethoscope} from "lucide-react"
            ...
            <div className={footerStyles.mainContent}>
                <div className={footerStyles.gridContainer}>
                    <div className={footerStyles.companySection}>
                        ...
                        <p className={footerStyles.companyDescription}>
                            Your trusted partner in healthcare inovation. We're committed 
                            to providing except exceptional medical care with cutting-ede technology 
                ...
                <div className={footerStyles.bottomSection}>
                    ...
                    <div className={footerStyles.designerText}>
                        ...
                        <a href="#" target='_blank' className={footerStyles.designerLink}>Dhruv Kumrawat Design Services</a>
                    </div>
                </div>
            </div>
