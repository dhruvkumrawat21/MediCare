...
import { commonStyles, contactPageStyles } from '../assets/dummyStyles'
...
const ContactPage = () => {
    ...
    function handleSubmit(e) {
        ...
        const url = `https://wa.me/8827928166?text=${encodeURIComponent(text)}`;
    ...
    return (
        <div className={contactPageStyles.pageContainer}> 
            ...
            <div className={contactPageStyles.gridContainer}>
                ...
                {/* RIGHT SIDE: Wrapper for stacking items vertically */}
                <div className="flex flex-col gap-6">
                    {/* 1. Visit Our Clinic Card */}
                    <div className={contactPageStyles.infoCard}>
                        ...
                        <p className={contactPageStyles.infoText}>
                            LIG Square, Hyderabad, Telangana.
                        </p>
                        <p className={contactPageStyles.infoItem}>
                            <Phone size={16}/> 8827928166
                        </p>
                        <p className={contactPageStyles.infoItem}>
