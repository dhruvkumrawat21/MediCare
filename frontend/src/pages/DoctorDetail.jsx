...
export default function DoctorDetail() {
  ...
  const handleBooking = async () => {
    ...
    try {
      //getting the token for user verification 
  ...
  //no doctor found on particlular id 
  if (!doctor)
    return (
