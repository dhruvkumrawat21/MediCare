...
//will return the time in 24 grs format 
...
//to convert thr 12 hrs clock to the 24 hrs clock 
...
//to get the details coming from the seerver side 
...
export default function DashboardPage({ apiBase }) {
  ...
  //to fetch the appointments of that particular doctor
...
//   /computes the value forr the filter
  ...
  async function updateStatusRemote(id, newStatusFrontend) {
    ...
    if (!appt) return;
    //if appointmen is completed or cancelled then no update in the status
