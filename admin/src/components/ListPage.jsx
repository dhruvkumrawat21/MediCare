...
//helper function
//this function will give us the output in format (dd-mm--yyyy)
...
//this function will normalize any date 
...
//this function will normalize schedule map: example :- "YYYY-MM-DD" : [slot1, slot2...];
//also it converts slots array to the empty array 
...
//the function will give you the past dates first
//that is nearest date comes first 
//or we csan say sorted according to the next date first 
...
const ListPage = () => 
{
    ...
    //to remove/delete the doctor by using the id 
    ...
    //shows all the doctor or the filtered ones 
                    ...
                    return (
                        <article key={id} className={doctorListStyles.article}>
                            <div className={doctorListStyles.articleContent}>
                                ...
                                />
                                <div
                                className={doctorListStyles.doctorInfoContainer}
                                style={{
                                    flex: 1,
                                    display: "flex",
                                ...
                                >
                                    ...
                                    >
                                        <div style={{ minWidth: 0 }}>
                                            ...
                                            <div style={{ marginTop: "6px"}} className='text-emerald-700'>
                                            ...
                                            <div
                                                ...
                                                >
                                                {/* Patients */}
                                                <span className="text-emerald-700">Patients</span>
                                                ...
                                                {/* Fees */}
                                                <span className={doctorListStyles.feesLabel}>Fees:</span>

                                                <span
                                                    className={doctorListStyles.feesValue}
                                                    style={{
                                                    display: "flex",
                                                    alignItems: "center",
                                                    gap: "2px",
