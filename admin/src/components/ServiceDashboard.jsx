...
//helper functions 
//normalize the backend data coming from the  data base (DB)
...
const ServiceDashboard = ({ services: servicesProp = null }) => {
    ...
    useEffect(() => {
      ...
      //start polling while tab is visible 
      ...
      //refresh the page and make the focus
      function onFocus() {
        fetchServices({ showLoading: false });
      }
      ...
      //refresh the page when tab is vosible 
    ...
    const INITIAL_COUNT = 8;   //initial 8 services are visible 
                            ...
                            return (
                              <div key={s.id} className={serviceDashboardStyles.table.row}>
                                  ...
                                  <div className={serviceDashboardStyles.table.desktopView}>
                                    ...
                                    <div className={`${serviceDashboardStyles.table.desktopCenterCell(2,)} text-right`}>
                                          {formatCurrency(earnings)} 
                                    </div>
                                  </div>
                ...
                <div className={serviceDashboardStyles.showMore.container}>
                  <button 
                    ...
                    className={serviceDashboardStyles.showMore.button}>
                      {showAll ? "Show less" : `Show more (${filteredServices.length})`}
                  </button>
