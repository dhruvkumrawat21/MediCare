...
//Helper functions
//this function will give you the output in minutes and according to time it will manage am or pm 
...
//this function willl convert the (YYYY-MM-DD) to date Month Year(DD-MM-YYYY)
...
const AddPage = () => {
    ...
    //compute the todays date in local time zone 
    ...
    //it will show the toast and will remove aftre the 3 seconds 
    useEffect(() => {
    ...
    //this function will show the image preview 
    ...
    //this function will remove the preview which we have seen using a previous finction 
    ...
    //to removing the added slot previously
    ...
    //it will convert the schedule Object into an array 
            ...
            <div className={s.maxWidthContainer + " " + s.formContainer}>
                <form onSubmit={handleAdd} className={s.formGrid}>
                    <div className="md:col-span-2">
                        <label className={s.label}>Upload Profle Image</label>
                    ...
                    >
                        ...
                        <option value="Unavailable">UnAvailabale</option>
                    </select>
                    <textarea 
                    ...
                    <div className={s.submitButtonContainer}>
                        <button 
                            type="submit" 
                            disabled={loading}
                            className={s.submitButton + " " + s.cursorPointer + " " + (loading ? s.submitButtonDisabled : s.submitButtonEnabled)}
                        >
            ...
            <div className={s.doctorListContainer}>
                {doctorList.length ? (
                    <div className={s.doctorListGrid}>
                        {doctorList.map((d) => (
                            <div key={d.id || d.email} className={s.doctorCardContent}>
