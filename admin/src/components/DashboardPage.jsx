...
import { BadgeIndianRupee, CalendarRange, CheckCheck, CheckCircle, XCircle, Users, UserCheck, Search } from 'lucide-react';
...
//to get the details of the doctor
...
const DashboardPage = () => 
{
    ...
    //to load doctors fromt the server 
     useEffect(() => 
    {
        let mounted = true;
        ...
        <div className={s.mobileDoctorCard}>
            ...
            <div className={s.mobileStatsGrid}>
                ...
                <div>
                    ...
                    <div className={s.mobileStatValue + " " + s.textEmerald600x}>{d.appointments.completed}</div>
                </div>
                <div>
                    <div className={s.mobileStatLabel}>Cancel</div>
                    <div className={s.mobileStatValue + " " + s.textRose600x}>{d.appointments.canceled}</div>
                </div>
            </div>
